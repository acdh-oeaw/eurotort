...
class CourtDecission(models.Model):
    ...
    def __str__(self):
        ...
        if self.file_number and self.party:
            return_value = (
                f"{self.party}, {self.court.name} {date_str} {self.file_number}"
            )
        elif self.file_number and self.court and self.court.name:
            return_value = f"{self.court.name} {date_str}, {self.file_number}".strip()
        elif self.party and self.court and self.court.name:
            return_value = f"{self.party}, {self.court.name} {date_str}"
        elif self.court and self.court.name:
            return_value = f"{self.court.name} {date_str}"
        else:
